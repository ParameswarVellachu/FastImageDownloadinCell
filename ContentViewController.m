...
@synthesize descriptionWeb = _descriptionWeb;
...
- (void)viewWillLayoutSubviews
{
	...
	if (fitToWidth)
	{
		...
		self.descriptionWeb.frame = CGRectMake(10,10,320,150);
	}
	else
	{
