...
- (void)viewDidLoad
{
	...
	{
        pageViewRect = CGRectMake(0, 150, 320, 350);
...
{
    ContentViewController *page = [[ContentViewController alloc]initWithNibName:@"ContentViewController" bundle:nil];
...
{
	if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
		return UIInterfaceOrientationIsPortrait(orientation)? MPFlipViewControllerOrientationHorizontal : MPFlipViewControllerOrientationHorizontal;
	else
